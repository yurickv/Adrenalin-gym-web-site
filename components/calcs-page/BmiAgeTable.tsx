  ...
  <section className="bg-white dark:bg-darkBody">
    <div className="div-container py-[20px] md:py-[44px] mx-auto">
      ...
      <p className="max-w-[900px] mx-auto mt-4 text-sm text-mainText dark:text-mainTextBlack">
        ВООЗ не коригує ІМТ за віком. Таблиця орієнтовна: з віком верхня межа норми поступово
        зростає, бо в старшому віці невеликий запас ваги повʼязують із нижчим ризиком ускладнень.
        Введіть вік у калькулятор, і він покаже норму для вашої вікової групи.
      </p>
    </div>
  </section>
);
