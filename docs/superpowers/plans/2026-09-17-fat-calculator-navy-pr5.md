...
describe('jacksonPollockBodyFat', () => {
  it('keeps the existing three-site formulas', () => {
    expect(jacksonPollockBodyFat('male', 30, 60)).toBe(18);
...
- [ ] **Step 3: Ручна перевірка в браузері** (`npm run dev`): чоловік 180/38/90 → 19,8%, «Середній рівень»; вага 80 → 15,8 і 64,2 кг; талія 35 → підказка; метод «За складками», 30 років, 20+20+20 → 18,0%; жінка з обхватами 165/33/75/98 → 28,4%; темна тема; зірки. Зупинити dev-сервер.
