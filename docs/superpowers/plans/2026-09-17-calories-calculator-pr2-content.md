...
- Перемикачі статі й мети: у темній темі при наведенні текст стає `dark:hover:text-mainTitle`, бо фон наведення `#d4d4d4` збігався з кольором тексту; апострофи в нових рядках уніфіковано до ʼ (U+02BC).
